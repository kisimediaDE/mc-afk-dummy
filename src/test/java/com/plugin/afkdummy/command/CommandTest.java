...
class CommandTest {
    ...
    @Test
    @DisplayName("Player bugreport directs support to the Community server operator")
    void testPlayerBugreportCommand() {
        ...
        assertTrue(captor.getValue().contains("AFKDummyLimited"));
        assertTrue(captor.getValue().contains("Betreiber dieses Servers"));
        assertFalse(captor.getValue().contains("over._.simplified"));
    }

    @Test
    @DisplayName("Console bugreport directs support to the Community server operator")
