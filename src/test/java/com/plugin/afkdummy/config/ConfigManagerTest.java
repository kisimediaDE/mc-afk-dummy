...
class ConfigManagerTest {
    ...
    class DefaultLoadingTests {
        ...
        void testDefaultSettings() {
            ...
            when(config.getInt("settings.max-server-wide-dummies", 6)).thenReturn(20);
            ...
            assertEquals(0, cm.getCostPerHour());
        ...
        void testMinimumClamping() {
            ...
            when(config.getInt("settings.max-server-wide-dummies", 6)).thenReturn(-5);
        ...
        static Stream<Arguments> provideCostCalculations() {
            ...
            for (int rate = 1; rate <= 10; rate++) {
                for (int hours = 1; hours <= 15; hours++) {
                    list.add(Arguments.of(rate, hours, 0));
                }
            }
            return list.stream();
        }
    ...
    class JsonConfigTests {
        ...
        void testLoadFromJson() throws Exception {
            ...
            assertEquals(0, cm.calculateCost(3));
        }
