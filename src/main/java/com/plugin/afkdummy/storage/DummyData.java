...
public class DummyData {
    ...
    public void setRemainingMillis(long value) { remainingMillis = Math.max(0, value); }
    public boolean hasRemainingMillis() { return remainingMillis != null; }
    ...
    public long getRemainingTimeMs() {
        return remainingMillis != null ? Math.max(0, remainingMillis) : Math.max(0, expirationTimestamp - System.currentTimeMillis());
    }
